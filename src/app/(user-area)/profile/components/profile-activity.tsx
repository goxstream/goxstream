              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="size-12 rounded-lg shrink-0 flex items-center justify-center relative overflow-hidden text-xs font-bold text-white shadow-xs bg-muted">
                      {isGradient ? (
                        <div
                      ...
                      <Play className="size-4 fill-white relative z-20 opacity-90 group-hover:scale-110 transition-transform" />
                    </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {favorites.slice(0, 3).map((item) => {
            ...
            return (
              ...
              >
                <div className="h-28 w-full rounded-md relative overflow-hidden flex items-end p-2 text-white shadow-xs bg-muted">
                  {isGradient ? (
                    <div
                      className="absolute inset-0 size-full"
                  ...
                  <Badge variant="secondary" className="relative z-20 text-[9px] px-1 py-0 h-4 bg-amber-500/20 text-amber-300 border-amber-500/30 gap-0.5">
